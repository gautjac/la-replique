...
export const STRINGS = {
  ...
  aiDramaturge: { fr: "Demander", en: "Ask" },
  aiDramaturgeDesc: { fr: "Pose une question sur ta pièce — un personnage, une scène qui mollit, une fin. Une lecture, pas un verdict.", en: "Ask a question about your play — a character, a sagging scene, an ending. A reading, not a verdict." },
  aiDramaturgeContext: { fr: "Sur quoi ?", en: "About what?" },
  aiWholePlay: { fr: "Toute la pièce", en: "The whole play" },
  aiDramaturgePlaceholder: { fr: "Ta question au dramaturge…", en: "Your question for the dramaturg…" },
  aiDramaturgeSend: { fr: "Envoyer", en: "Send" },
  aiDramaturgeClear: { fr: "Nouvelle conversation", en: "New conversation" },
  aiDramaturgeStarters: { fr: "Pour commencer", en: "To get started" },
  aiDramaturgeFollowups: { fr: "Et ensuite…", en: "And next…" },
  aiDramaturgeYou: { fr: "Toi", en: "You" },
  aiDramaturgeHim: { fr: "Le dramaturge", en: "The dramaturg" },
  aiStageRereading: { fr: "je relis la pièce…", en: "re-reading the play…" },
  aiStageAnswering: { fr: "je réfléchis…", en: "thinking it over…" },
  aiStarter1: { fr: "Qu'est-ce que {name} veut vraiment ici, et qu'est-ce qui l'en empêche ?", en: "What does {name} really want here, and what stands in the way?" },
  aiStarter2: { fr: "Où la scène tourne-t-elle ? Où est-ce qu'elle mollit ?", en: "Where does the scene turn? Where does it go slack?" },
  aiStarter3: { fr: "Ma fin est-elle gagnée, ou seulement annoncée ?", en: "Is my ending earned, or only announced?" },
  aiStarter4: { fr: "Quel personnage est le plus faible, et pourquoi ?", en: "Which character is the weakest, and why?" },
